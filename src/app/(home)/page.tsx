      ...
      <section className="container mx-auto max-w-[1400px] py-16 lg:py-20">
        <div className="flex flex-col items-center gap-16">
          ...
          <div className="flex flex-col items-center justify-center gap-6 text-center">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl">
                <span className="block text-blue-800">PharmScribe.ai</span>
              ...
              <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
                Revolutionizing pharmacist-patient interactions with real-time AI transcription and 
                SmartDocs.
              </p>
            </div>
            ...
            <div className="flex gap-4 mt-4">
              <Link href="/register">
                <Button size="lg" className="py-6 px-8 text-lg bg-blue-600 hover:bg-blue-600">
                  Get Started
                </Button>
              </Link>
              <Link href="#demo">
          ...
          <div className="relative w-full max-w-5xl">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-blue-700 rounded-lg blur opacity-30"></div>
