...
export const metadata: Metadata = {
  title: "PharmScribe - Connect with Ease",
  description:
    "Sign in to PharmScibe and start connecting with your friends, family, and colleagues through seamless video calls.",
};
        ...
        <div className="mx-auto -mt-16 flex w-[330px] flex-col justify-center gap-8 sm:w-[370px]">
          <div>
            ...
            <h1 className="mb-0.5 text-2xl font-medium tracking-tight">
              Connect with PharmScribe
            </h1>
            <p className="text-sm text-muted-foreground">
              Welcome back! Sign in to your PharmScribe account
            </p>
          </div>
          <SocialAuthForm />
